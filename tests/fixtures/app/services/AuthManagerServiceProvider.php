...
class AuthManagerServiceProvider implements ServiceProviderInterface
{
    const SERVICE_NAME = 'authManager';
    ...
    public function register(DiInterface $di)
    {
        $di->set(self::SERVICE_NAME, function () use ($di) {
            ...
            $adapter->setSessionStorage($di->get('sessionManager')->createScope('authManager'));
